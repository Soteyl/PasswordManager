...
public class CancelMessageCommand(IUserDataRepository userDataRepository, IMemoryCache memoryCache, ITelegramCommandResolver commandResolver) : MessageCommand(userDataRepository)
{
